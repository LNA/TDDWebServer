...
public class RouteFactoryTest {
    ...
    @Test
    public void itHasAGetPatchRoute() throws IOException {
        assertEquals(true, routes.containsKey("GetPatch"));
        assertEquals(true, routes.get("GetPatch") instanceof GetPatchRouter);
    }
}